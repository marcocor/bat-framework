...
public class AIDAPriorityOnlyAnnotator extends AIDAAnnotator {

	public AIDAPriorityOnlyAnnotator(String configFile, WikipediaApiInterface api)
	...
	public DisambiguationSettings setDisambiguationSettings() throws MissingSettingException {
		return new PriorOnlyDisambiguationSettings();
	}

	@Override
	public String getName() {
		return "AIDA-PriorityOnly";
	}
