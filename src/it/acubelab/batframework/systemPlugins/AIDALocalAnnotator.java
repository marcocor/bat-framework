...
public class AIDALocalAnnotator extends AIDAAnnotator {

	public AIDALocalAnnotator(String configFile, WikipediaApiInterface api)
	...
	public DisambiguationSettings setDisambiguationSettings() throws MissingSettingException {
		return new LocalDisambiguationSettings();
	}
